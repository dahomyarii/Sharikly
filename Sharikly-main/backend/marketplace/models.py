...
class Review(models.Model):
    ...
    def not_helpful_count(self):
        return self.not_helpful_marks.count()
# class ReviewHelpfulMark(models.Model):
...
#     class Meta:
#         unique_together = ("review", "user")  # one mark per user per review

#     def __str__(self):
#         return f"Helpful mark by {self.user.email} on Review {self.review.id}"

# class ReviewNotHelpfulMark(models.Model):
#     review = models.ForeignKey(Review, on_delete=models.CASCADE, related_name="not_helpful_marks")
#     user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="not_helpful_reviews")
#     created_at = models.DateTimeField(auto_now_add=True)
...
#     def __str__(self):
#         return f"Not Helpful mark by {self.user.email} on Review {self.review.id}"
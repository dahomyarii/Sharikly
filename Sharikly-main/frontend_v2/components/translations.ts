...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    careers_subtitle: "Help us build the future of peer-to-peer sharing.",
    open_positions: "Open Positions",
    benefits: "Benefits",
    job_title_fullstack: "Full Stack Developer",
    job_title_pm: "Product Manager",
    job_title_cm: "Community Manager",
    dept_engineering: "Engineering",
    dept_product: "Product",
    dept_community: "Community",
    job_type_fulltime: "Full-time",
    benefit_salary: "Competitive salary",
    benefit_hours: "Flexible work hours",
    benefit_growth: "Professional growth",
  },
  ar: {
    // Navigation & Header
    home: "الرئيسية",
    ...
    careers_subtitle: "ساعدنا في بناء مستقبل المشاركة بين الأقران.",
    open_positions: "الوظائف الشاغرة",
    benefits: "المميزات",
    job_title_fullstack: "مطور ويب متكامل (Full Stack)",
    job_title_pm: "مدير منتج",
    job_title_cm: "مدير مجتمع",
    dept_engineering: "الهندسة",
    dept_product: "المنتج",
    dept_community: "المجتمع",
    job_type_fulltime: "دوام كامل",
    benefit_salary: "راتب تنافسي",
    benefit_hours: "ساعات عمل مرنة",
    benefit_growth: "نمو مهني",
  },
};

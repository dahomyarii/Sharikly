...
export default function ListingCard({
  ...
  return (
    <Link
      ...
      className={`block overflow-hidden transition-all duration-200 mobile-card border border-border bg-card rounded-3xl ${
        highlighted ? "ring-2 ring-primary/40" : ""
      }`}
    >
      <div className={`relative ${imageHeight} bg-muted rounded-2xl rounded-b-none overflow-hidden`}>
        <img
          src={imageUrl}
          alt={listing.title}
